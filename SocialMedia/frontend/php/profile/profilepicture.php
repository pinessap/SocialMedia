            ...
            <div class="form">
                <form action="" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <hr>
                        <input type="button" class="form-control fileupload" value="Select Image File" onclick="document.getElementById('profilepic').click();" />
                        <input style="display:none;" type="file" class="form-control" id="profilepic" name="profilepic" required>
                    </div>
                    <hr>
                    <br>
                    <button type="submit" name="submitnew" id="submitnew" class="standardbtn">Upload Picture</button>
                </form>
            </div>
        </div>
    </div>
