<nav class="navbar navbar-expand-lg navbar-light" style="background-color:#678056;">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <?php //if ($page == 'index') { 
          ?>
            <a class="nav-link active" aria-current="page" href="php/showChat.php">Chat</a>
          <?php //} elseif ($page == 'profile') { 
          ?>
            <a class="nav-link active" aria-current="page" href="showChat.php">Chat</a>
        ...
        <li class="nav-item">
          <?php if ($page == 'index') { ?>
            <a class="nav-link active" aria-current="page" href="php/groups.php">Groups</a>
          <?php } elseif ($page == 'profile') { ?>
            <a class="nav-link active" aria-current="page" href="groups.php">Groups</a>
          <?php } else { ?>
            <a class="nav-link active" aria-current="page" href="groups.php">Groups</a>
          <?php } ?>
        </li>
