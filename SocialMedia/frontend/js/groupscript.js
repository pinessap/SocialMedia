            ...
            success: function (response) {
                ...
                if (response == -1){
                    ...
                    $.each(response, function(i, p) {
                        ...
                        event_data += '<div class="show_gr" id="'+ p.id +'"><a class="friendlink" href="showChat.php?groupID='+p.id+'">'+p.name+'</a><button class="showMemberbtn" type="button" onClick="showMembers('+p.id+')">show members</button> <button class="leaveGroupbtn" type="button" onClick="leaveGroup('+p.id+')">leave group</button></div>';
                    });
                }
    ...
    if (first_sh_mb == 0){
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $.each(response, function(i, p) {
                    //console.log(i,p.id, "," ,p.username);
                    event_data += '<div class="show_members" id="'+ p.id +'"><a class="friendlink" href="showUser.php?username='+p.username+'">'+p.username+'</a></div>';
            ...
            success: function (response) {
                ...
                if (response == -1){
                    ...
                    $.each(response, function(i, p) {
                        ...
                        event_data += '<div class="show_fr" id="'+ p.id +'"><a class="friendlink" href="showUser.php?username='+p.username+'">'+p.username+'</a><button class="showGroupbtn" type="button" onClick="showGroups('+p.id+')">add to group</button></div>';
                    });
                }
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response == -1){
                    ...
                    $.each(response, function(i, p) {
                        //console.log(i,p.id, "," ,p.username);
                        event_data += '<div class="show_gr_fr" id="'+ p.id +'"><a class="friendlink" href="showChat.php?groupID='+p.id+'">'+p.name+'</a><button class="addToGroupbtn" type="button" onClick="addToGroup(\''+p.id+'\',\''+fid+'\')">add</button></div>';
