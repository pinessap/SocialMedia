            ...
            success: function (response) {
                ...
                if (response == -1){
                    ...
                    $.each(response, function(i, p) {
                        ...
                        event_data += '<div class="fr_req" id="'+ p.id +'"><a class="friendlink" href="showUser.php?username='+p.username+'">'+p.username+'</a><button class="acceptFriendbtn" type="button" onClick="acceptFriend('+p.id+')">accept</button> <button class="rejectFriendbtn" type="button" onClick="deleteFriend('+p.id+')">reject</button></div>';
                    });
                }
            ...
            success: function (response) {
                ...
                if (response == -1){
                    ...
                    $.each(response, function(i, p) {
                        ...
                        event_data += '<div class="show_fr" id="'+ p.id +'"><a class="friendlink" href="showUser.php?username='+p.username+'">'+p.username+'</a><button class="removeFriendbtn" type="button" onClick="deleteFriend('+p.id+')">remove friend</button></div>';
                    });
                }
        ...
        if (input != ""){
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $("#friend_search").append(event_data);
                },
                error: function(xhr, textStatus, error) {
                    console.log('status: ' + textStatus);
                    console.log(xhr.responseText + " / " + xhr.status);
