    ...
    <div class="container">
        ...
        <div class="form">
            <form action="" method="POST">
                ...
                <button class="ticketbtn" data-bs-toggle="modal" data-bs-target="#deleteModal" type="button">Delete Profile</button>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" id="del_acc">Yes, delete my Account</button>
